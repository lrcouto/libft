...
#    Updated: 2020/03/06 15:19:02 by lcouto           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ADDISRCS = ft_strnew.c ft_strdel.c ft_itoa_base.c ft_itoa_u.c ft_itoa_ptr.c
...
ADDIOBJS = ft_strnew.o ft_strdel.o ft_itoa_base.o ft_itoa_u.o ft_itoa_ptr.o
